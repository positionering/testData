...
p1pid=$!
./GPS/build/libsbp_tcp_example -a 192.168.0.222 -p 55555 > test/cord222/$3_222.log &
p2pid=$!
./GPS/build/libsbp_tcp_example -a 192.168.0.223 -p 55555 > test/cord223/$3_223.log &
p3pid=$!
